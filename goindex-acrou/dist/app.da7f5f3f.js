(function (e) {
    function t(t) {
        for (var n, r, c = t[0], s = t[1], u = t[2], d = 0, l = []; d < c.length; d++)
            r = c[d], Object.prototype.hasOwnProperty.call(o, r) && o[r] && l.push(o[r][0]), o[r] = 0;
        for (n in s)
    ...
    s.p = "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@2.0.8-darkmode-0.1/goindex-acrou/dist/",
    s.oe = function (e) {
    ...
    "56d7": function (e, t, a) {
        ...
        j = function (e, t) {
            return new Promise((function (a, n) {
                    ...
                    x.appendToBody && document.body.appendChild(r),
                    r.click(),
                    x.appendToBody && document.body.removeChild(r)
                }))
        },
        P = {
            copy: j,
    ...
    "95a2": function (e, t, a) {
        ...
        c = a("c276"),
        s = a("60bb"),
        u = new i.a("go2index-".concat("2.0.8-darkmode-0.1")),
        d = r()(u);
        function l(e) {
            var t = e.dbName,
    ...
    "9bd2": function (e, t, a) {
        ...
        c = r.a.create({
                baseURL: Object({
                    ...
                    BASE_URL: "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@2.0.8-darkmode-0.1/goindex-acrou/dist/"
                }).VUE_APP_API ? Object({
                    NODE_ENV: "production",
                    VUE_APP_I18N_LOCALE: "zh-chs",
                    VUE_APP_I18N_FALLBACK_LOCALE: "en",
    ...
    c276: function (e, t, a) {
        ...
        o = {
            set: function () {
                ...
                Object.assign(n, a),
                r.a.set("go2index-".concat("2.0.8-darkmode-0.1", "-").concat(e), t, n)
            },
            get: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                return r.a.get("go2index-".concat("2.0.8-darkmode-0.1", "-").concat(e))
            },
            getAll: function () {
                return r.a.get()
            },
            remove: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                return r.a.remove("go2index-".concat("2.0.8-darkmode-0.1", "-").concat(e))
            }
        },
        i = o,
        c = a("95a2"),
    ...
    cbd9: function (e, t, a) {
        "use strict";
        function n(e) {
            var t = "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@2.0.8-darkmode-0.1/goindex-acrou/dist/";
            return t + e
        }
        a.d(t, "a", (function () {
                return n
